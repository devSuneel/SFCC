...
function ShippingModel(shipment, address, customer, containerView) {
    ...
    if (fenixIntelligentDeliveryUtils.isFenixIntelligentDeliveryEnabled()) {
        ...
        var deliveryPostalCode = fenixIntelligentDeliveryUtils.getDeliveryPostalCode(null, customer, this.shippingAddress);
        ...
        **/
        if (deliveryPostalCode) {
            var fenixIntelligentDeliveryGotResponse = fenixIntelligentDeliveryUtils.getEstimates(null, null, deliveryPostalCode, Resource.msg('FenixIntelligentDelivery.CheckOut', 'fenixIntelligentDelivery', 'COP'));
            var fenixIntelligentDeliveryGetResponse = fenixIntelligentDeliveryUtils.getDeliveryResonseObject(fenixIntelligentDeliveryGotResponse);
            var fenixIntelligentDeliveryResponse = fenixIntelligentDeliveryUtils.deliveryEstimate(fenixIntelligentDeliveryGotResponse.Response);
            var shippingMethods = fenixIntelligentDeliveryUtils.getApplicableShippingMethods(this.applicableShippingMethods, fenixIntelligentDeliveryGetResponse);
