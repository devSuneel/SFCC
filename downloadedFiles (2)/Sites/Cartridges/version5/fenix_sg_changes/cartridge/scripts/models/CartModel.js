...
var CartModel = AbstractModel.extend({
    ...
    addBonusProduct: function (bonusDiscountLineItem, product, selectedOptions, quantity) {
        ...
        var UpdateProductOptionSelections = require('sg_fx_core/cartridge/scripts/cart/UpdateProductOptionSelections');
    ...
    validateForCheckout: function () {
        var ValidateCartForCheckout = require('sg_fx_core/cartridge/scripts/cart/ValidateCartForCheckout');
    ...
    separateQuantities: function (pli, quantityLineItems) {
        ...
        for (var i = 0; i < quantity; i++) {
            ...
            if (isEmpty(pli.custom.fromStoreId)) {
    ...
    getAddressBookAddresses: function () {
        ...
        if (!isEmpty(this.object.describe().getCustomAttributeDefinition('sessionAddressBook'))) {
